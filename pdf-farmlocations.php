<?php
 function fetch_data()
 {
      ...
      $sql = "SELECT t1.refid, t1.agriculturistid, t1.address, t1.longitude, t1.latitude, t1.active, t1.farmtype, t2.firstname, t2.lastname FROM tbl_farmlocations AS t1 LEFT JOIN tbl_agriculturist AS t2 ON t2.refid=t1.agriculturistid";
 ...
 <html>
    ...
    <link rel="stylesheet" type="text/css" href="./assets/lib/materialize/css/materialize.min.css" media="screen,projection">
      ...
      <body>
           <br /><br />
           <div class="container" >
                <h1 align="center">Export Farm Locations and Farm Type Records</h1><br />
                <div>
                     ...
                     <form method="post">
                        <a href="farmlocations.php" class="btn waves-effect waves-light">Back to Farmlocation<i class="material-icons left">arrow_back</i></a>
